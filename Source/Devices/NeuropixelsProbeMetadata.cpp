...
std::string NeuropixelsProbeMetadata::getProbeTypeString(std::string partNumber)
{
    if (partNumber == "PRB_1_4_0480_1" || partNumber == "PRB_1_4_0480_1_C" || partNumber == "PRB_1_2_0480_2")
        return ProbeTypeString.at (ProbeType::NPX_V1);

    else if (partNumber == "NP2003" || partNumber == "NP2004")
        return ProbeTypeString.at (ProbeType::NPX_V2_SINGLE_SHANK);

    else if (partNumber == "NP2013" || partNumber == "NP2014")
        return ProbeTypeString.at (ProbeType::NPX_V2_QUAD_SHANK);
