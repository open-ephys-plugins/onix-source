    ...
    : SettingsInterface (d, e, c)
{
    ...
    gateRunButton->setTooltip ("Toggles the output clock gate. If checked, the clock output will follow the acquisition status." + std::string (" If unchecked, the clock output will run continuously."));
